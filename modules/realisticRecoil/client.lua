            ...
            while true do
                ...
                if IsPedShooting(ped) then
                    ...
                    elseif group == 1159398588 then
                        lmg = true
                    elseif group == 3082541095 or group == 2725924767 then
                        sniper = true
                    ...
                    if pistol then
                        recoil = recoil * cfg.realisticrecoil.recoilMultipliers["PISTOL"]
                    elseif smg then
                        recoil = recoil * cfg.realisticrecoil.recoilMultipliers["SMG"]
                    elseif rifle then
                        recoil = recoil * cfg.realisticrecoil.recoilMultipliers["RIFLE"]
                    elseif shotgun then
                        recoil = recoil * cfg.realisticrecoil.recoilMultipliers["SHOTGUN"]
                    elseif lmg then
                        recoil = recoil * cfg.realisticrecoil.recoilMultipliers["LMG"]
                    elseif sniper then
                        recoil = recoil * cfg.realisticrecoil.recoilMultipliers["SNIPER"]
                    end
                    local set = p + recoil
