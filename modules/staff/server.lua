...
local function getMenuEntries()
    ...
    for k, v in pairs(players) do
        local player =
            exports.qbx_core:GetPlayerByCitizenId(v.citizenid) or exports.qbx_core:GetOfflinePlayer(v.citizenid)
...
lib.addCommand(
    ...
    function(source, args, raw)
        ...
        sendNotification(
            ...
            string.format(
                "Permissão %s %s a: %d",
                args.cargo or player.PlayerData.metadata["staff"],
    ...
    function(data)
        ...
        if player then
            ...
            sendNotification(
                ...
                string.format(
                    "Permissão '%s' %s a: %s",
                    data.role or player.PlayerData.metadata["staff"],
