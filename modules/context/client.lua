...
function AbrirMenuJogador()
    ...
    table.insert(
        ...
        addMenuItem(
            ...
            "fas fa-address-card",
            "fade",
            getPlayerInformation(PlayerData),
            ExecuteCommand,
            "id"
        )
    )
    ...
    table.insert(
        options,
        addMenuItem("Gangue", "gun", "fade", gangData.label .. " | " .. gangData.grade, ExecuteCommand, "gang")
    )
    if PlayerData.gang.isboss then
        table.insert(
            options,
            addMenuItem("Gerenciar Gangue", "users", "fade", "Configurações da gangue.", ExecuteCommand, "+tablet:gang")
        )
    end
    table.insert(
        options,
        addMenuItem(
            ...
            "book",
            "fade",
            "Exibir o nível de reputação do seu personagem.",
            ExecuteCommand,
            "rep"
        )
    )
    table.insert(
        ...
        addMenuItem(
            ...
            "fade",
            "Exibir o nível de habilidades do seu personagem.",
            ExecuteCommand,
            "skill"
        )
    )
    table.insert(
        ...
        addMenuItem(
            ...
            "location-dot",
            "fade",
            "Configurações do sistema de waypoints (ponto de referência).",
            AbrirMenuWaypoints,
            nil,
            true
        )
